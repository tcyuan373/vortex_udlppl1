    ...
    def process_and_emit_results(self, to_send):
        for idx, batch_manager in enumerate(to_send):
            ...
            while num_sent < batch_manager.num_queries:
                ...
                if serialize_batch_size != 1:
                    print("Warning: serialize_batch_size is not 1 at StepBEmitWorker")
                start_pos = num_sent
                ...
                new_key = STEPB_NEXT_UDL_PREFIX + str(batch_manager.question_ids_list[start_pos]) 
...
class StepBUDL(UserDefinedLogic):
    ...
    def __init__(self,conf_str):
        ...
        self.max_emit_batch_size = 1 # use 1, since it needs to be fetch by stepD later
